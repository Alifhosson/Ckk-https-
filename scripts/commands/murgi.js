...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস যে মুরগি কে চুদ্দে চাউ সেই মুরগি বাইন চোদরে @ম্যানশন দেউ", event.threadID);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি  আলিফ তর বাপ মাগির পোলা 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "তোর মারে আলিফ প্রতি রাতে কন্ডম ছারা চুদে তাই কি তুই জানো 😹👈" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "বস্তির পোলা অনলাইনের কিং" + " " + name, mentions: arraytag})}, 132000);
...
setTimeout(() => {a({body: "খাঙ্কিরপোলা কথা শুন তর আম্মু রে চুদি গামছা পেচিয়ে🐰" + " " + name, mentions: arraytag})}, 180000);
setTimeout(() => {a({body: "Hi আলিফ এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "বস্তির পোলা তোর বইনরে মুসলমানি দিমু।" + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "খাঙ্কিরপোলা তর বোনের  হোগায় ইনপুট, তর মায়ের ভোদায় আউটপুট।🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "জং ধরা লোহা দিয়া পাকিস্তানের মানচিত্র বানাই্য়া তোদের পিছন দিয়া ঢুকামু।🤬 " + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "বস্তির পোলা তর মায়ের ভুদাতে পোকা।" + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ আমার পোলা। জা ভাগ🤖")} , 39000);
setTimeout(() => {a({body: "তোর মারে চুদি কন্ডম ছারা😋।।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তোরে আবার তোর মার বোদার বিতরে ডুকানোর আগে মাপ চা🤬।।" + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "তোর বোনের ওই কছি ছামায় উম্মা😚।।" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "তুই নাকি কন্ডম দুর র্ঘটনায় হয়ে ছো 😹।।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তোর বউরে আমি রাতে ভালো বাসি কন্ডম ছারা🥵।।" + " " + name, mentions: arraytag})}, 180000);
setTimeout(() => {a({body: "তোর ওই কচি বোনের বোদায় উম্ম সেই টেস্ট😚।।" + " " + name, mentions: arraytag})}, 168000);
setTimeout(() => {a({body: "তুই তো একটা হিজলা মাদার চোদ তোরে আর কি বলবো😹🤣।।" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "তুই তো প্রতি দিন গরু চুদছ তুই আইছে আমাদের সাথে লাগদে গরু চোদা শালা🤬।।" + " " + name, mentions: arraytag})}, 31000);
setTimeout(() => {a({body: "তোর মাকে আছকে রাতে চুদে জাবো তুই বাসায় থাকিস না ওকে 🤣।।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তোর বউরে কুওা চোদা দিবো 🥵।।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তুই তো একটা বাচ্চা তোরে আর কি চুদবো জা বাসায় জা বাসায় গিয়া তোর মার ধুদ খা জা মাদার চোদ🍼।।" + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a({body: "🖕 স্ক্যামার মাদারফাকার তোর মায়ের পাছা চুদছে 🤮🤢 কন্ডম ছারা🤬🤬" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "ফাটা কন্ডমের ফলাফল তুই ! 😂😂" + " " + name, mentions: arraytag})}, 2050);
setTimeout(() => {a({body: "চুট কে বাল স্তনবৃন্ত কি ধন তেরি গাঁদ মাই রোড রোলার দে দুঙ্গা 🖕🤬" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদি 🥰।" + " " + name, mentions: arraytag})}, 3000);
